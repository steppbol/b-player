...
Данное тестирование является модульным и производиться над каждой атомарной функциональностью приложения отдельно, также является дымовым, и будет проводиться по типу "Black box", т. е. без доступа к исходному коду.
